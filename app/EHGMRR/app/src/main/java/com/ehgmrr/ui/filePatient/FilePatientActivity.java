...
public class FilePatientActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        mFindLocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FilePatientActivity.this, MapsActivity.class);
    ...
    private void getData() {
        ...
        mRvUsers.setLayoutManager(new LinearLayoutManager(FilePatientActivity.this, RecyclerView.VERTICAL, false));
        viewPatentAdapter = new ViewPatentAdapter(FilePatientActivity.this, userArrayList);
